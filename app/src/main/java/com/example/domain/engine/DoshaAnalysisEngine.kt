...
object DoshaAnalysisEngine {
    ...
    fun analyzeDoshas(profile: AstrologyProfile): List<DoshaAnalysisResult> {
        ...
        // Deterministic sorting: Detected & active first, then detected & cancelled, then non-detected
    ...
    private fun evaluateGandmantaDosha(moonPos: PlanetPosition?): DoshaAnalysisResult? {
        ...
        // Gandmanta (Gandmool) junctions:
        // Ashwini pada 1 (Aries junction)
        // Ashlesha pada 4 (Cancer junction)
        // Magha pada 1 (Leo junction)
        // Jyeshtha pada 4 (Scorpio junction)
        // Mula pada 1 (Sagittarius junction)
        // Revati pada 4 (Pisces junction)
