...
object YogaRuleEngine {
    ...
    private fun evaluatePanchaMahapurushaYogas(planets: List<PlanetPosition>): List<YogaAnalysisResult> {
        ...
        list.add(
            YogaAnalysisResult(
                ...
                status = if (isRuchaka) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
        ...
        list.add(
            YogaAnalysisResult(
                ...
                category = YogaCategory.MAHAPURUSHA_YOGA,
                status = if (isBhadra) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
        ...
        list.add(
            YogaAnalysisResult(
                ...
                category = YogaCategory.MAHAPURUSHA_YOGA,
                status = if (isHamsa) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
        ...
        list.add(
            YogaAnalysisResult(
                ...
                category = YogaCategory.MAHAPURUSHA_YOGA,
                status = if (isMalavya) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
        ...
        list.add(
            YogaAnalysisResult(
                ...
                category = YogaCategory.MAHAPURUSHA_YOGA,
                status = if (isSasa) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
    ...
    private fun evaluateGajaKesariYoga(
        ...
        return YogaAnalysisResult(
            ...
            status = if (isGk) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
            strength = strength,
    ...
    private fun evaluateBudhadityaYoga(planetByName: Map<String, PlanetPosition>): YogaAnalysisResult? {
        ...
        return YogaAnalysisResult(
            ...
            status = if (isConjoined) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
            strength = strength,
    ...
    private fun evaluateChandraMangalaYoga(
        ...
        return YogaAnalysisResult(
            ...
            status = if (isDetected) AnalysisStatus.DETECTED else AnalysisStatus.NOT_DETECTED,
            strength = strength,
